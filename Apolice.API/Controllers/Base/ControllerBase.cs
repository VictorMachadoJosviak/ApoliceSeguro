...
namespace Apolice.API.Controllers.Base
{
    public class ControllerBase : ApiController
    {
        ...
        public async Task<HttpResponseMessage> ResponseAsync(object result, IServiceBase serviceBase)
        {
            ...
            if (!serviceBase.Notifications.Any())
            {
                ...
                {
                    return Request.CreateResponse(HttpStatusCode.Conflict, $"Houve um problema interno com o servidor. Entre em contato com o Administrador do sistema caso o problema persista.");
                }
            }
            else
            {
